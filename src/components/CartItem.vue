<template>
  <li class="cart__item product">
    ...
    <div class="product__counter form__counter">
      <button type="button" class="button" aria-label="Убрать один товар" :disabled="quantity < 2" @click="quantity--">
      ...
      <button type="button" class="button" aria-label="Добавить один товар" @click="quantity++">
        <svg width="10" height="10" fill="currentColor">
