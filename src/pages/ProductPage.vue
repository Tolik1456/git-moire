          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row item__row--center">
              <div class="form__counter">
                <button class="button" @click="productAmount--" :disabled="productAmount < 2" type="button"
                ...
                <button class="button" @click="productAmount++" type="button" aria-label="Добавить один товар">
                  <svg width="12" height="12" fill="currentColor">
                ...
                <ul class="colors">
                  <li class="colors__item" v-for="(col, index) in product.colors.length" :key="col.id">
                    <label class="colors__label">
                      <input class="colors__radio sr-only" type="radio" v-model="productColor"
